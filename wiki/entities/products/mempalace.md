...
> 开源 AI memory system，GitHub 48K Stars，Benchmark 表现最佳
...
- 作为 [[llm-wiki]] 生态的一部分，memory system 是 AI Agent 持久化的关键技术组件
- 与 [[openclaw]] 等 Agent 框架有潜在集成关系
- 参见 [[ai-agent]] 概念页
- 作为 [[ai-skills]] 生态中的基础设施层，支持 Agent 记忆能力
