...
**关联**：[[concepts/programming/spa-history-fallback|SPA History 路由与服务端 Fallback]]
...
**关联**：[[concepts/programming/feature-based-architecture|Feature-Based 架构]] · [[entities/products/bulletproof-react|Bulletproof React]]
...
| Server Cache State | 远端 API | [[entities/products/tanstack-query|TanStack Query]] / [[entities/products/swr|SWR]] |
| Form State | 表单字段 | React Hook Form + zod |
| URL State | URL path/query/hash | react-router / Next.js router |

**关联**：[[concepts/programming/react-state-categories|React 状态五分类]]
...
**关联**：[[concepts/programming/server-state-management|服务端状态管理]] · [[sources/articles/react-query-vs-swr-server-state-source-compare|React Query vs SWR 源码对比]]
...
**关联**：[[concepts/programming/react-page-state-antipatterns|React 页面状态管理反模式]]
...
**关联**：[[concepts/programming/react-classic-antipatterns|React 经典反模式（组件层）]]
...
| React 栈 | 后端类比 |
|---------|---------|
| L1 Feature-Based | [[concepts/microservices|微服务架构]]（按业务边界切） |
| L2 状态分层 | [[concepts/backend-architecture|Clean Architecture]] 的"按来源分层" |
| L3 TanStack Query | 后端的 ORM / Repository + 缓存层 |
| L4 页面重构 | 后端的 service 层重构 |
| L5 组件纪律 | [[concepts/clean-code|整洁代码]] 的"函数级"建议 |

**共同底层**：[[concepts/solid-principles|SOLID]]（S 单一职责、D 依赖反转）、[[concepts/clean-code|DRY/KISS/YAGNI]]。
...
| L1 | [[entities/products/bulletproof-react|Bulletproof React]]（参考实现） |
| L2 | —（方法论层，非工具） |
| L3 | [[entities/products/tanstack-query|TanStack Query]] · [[entities/products/swr|SWR]] |
| L4 | —（重构方法论） |
| L5 | —（纪律层，Immer 可选） |
...
- **L0**：[[concepts/programming/spa-history-fallback|SPA History 路由与服务端 Fallback]]
- **L1**：[[concepts/programming/feature-based-architecture|Feature-Based 架构]]
- **L2**：[[concepts/programming/react-state-categories|React 状态五分类]]
- **L3**：[[concepts/programming/server-state-management|服务端状态管理]]
- **L4**：[[concepts/programming/react-page-state-antipatterns|React 页面状态管理反模式]]
- **L5**：[[concepts/programming/react-classic-antipatterns|React 经典反模式（组件层）]]

## 来源

- [[sources/articles/bulletproof-react-github|Bulletproof React]] — L1 / L2 / L3 的系统化参考
- [[sources/articles/react-bits-github|React Bits]] — L5 的词典
- [[sources/articles/react-query-vs-swr-server-state-source-compare|React Query vs SWR 源码对比]] — L3 的深入
