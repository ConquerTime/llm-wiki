...
| 项目 | 方向 | Stars |
|------|------|-------|
| MemPalace/mempalace | AI 记忆系统 | 46,487 |
| career-ops | AI 求职系统 | 33,861 |
| caveman | Token 优化 | 32,155 |
| graphify | 知识图谱构建 | 27,227 |
| nuwa-skill | 思维蒸馏（六路Agent并行+三重验证） | 11,300 |
| gbrain | OpenClaw/Hermes Brain | 8,237 |
| zhangxuefeng-skill | 职业规划 | 5,911 |
| khazix-skills | AI Skills 合集 | 4,644 |
